            ...
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6 pb-6 border-b border-slate-100">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-xs text-slate-500 mt-2 leading-relaxed">
                  ผู้ถูกคุมประพฤติสัญชาติไทย สังกัดสำนักงานคุมประพฤติจังหวัดสงขลา อยู่ในกระบวนการฟื้นฟูช่วยเหลือฟื้นฟูจิตใจและฝีมือแรงงานเพื่อกลับคืนสู่สังคมอย่างสงบสุขและมีอนาคตที่มั่นคง
                </p>
              </div>
            </div>
