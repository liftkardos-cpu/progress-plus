// ==========================================
// 🇹🇭 ไฟล์: /src/views/officer/CaseClosedApprovals.tsx
// คำอธิบาย: ระบบอนุมัติปิดแฟ้มคดีและพิมพ์ใบร้องเสนอพ้นคุมความประพฤติ (Case Closed Approvals)
// โครงสร้างไฟล์:
//   - ส่วนนำเข้าข้อมูลและหัวใบงาน (Imports)
//   - ตัวแปรคัดเลือกผู้ถูกคุมประพฤติที่บำเพ็ญชั่วโมงครบ (Eligible Selection Logic)
//   - ฟังก์ชันจัดการปิดคำร้องคดี (Case Closing Logic & Notification)
//   - แบบจำลองกระดาษเอกสารเสนอความเห็นส่งศาลแขวงสงขลา (Official Document Preview)
// ==========================================
...
export const CaseClosedApprovals: React.FC = () => {
  ...
  const handleCloseCase = () => {
    ...
    alert(`🎉 ดำเนินการอนุมัติปิดแฟ้มคดีและยื่นเสนอสำนักศาลจังหวัดสงขลาให้แก่คุณ ${activeProbationer.name} สำเร็จ!`);
  };
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
              ...
              <div className="bg-[#fcfdfa] p-8 rounded-xl border border-slate-300 font-serif leading-relaxed text-slate-800 text-[11px] shadow-inner max-w-2xl mx-auto space-y-4 relative overflow-hidden">
                ...
                <div className="text-center space-y-1">
                  ...
                  <p className="text-slate-500">สังกัด: สำนักงานคุมประพฤติจังหวัดสงขลา</p>
                </div>

                <div className="text-right">
                  <p>เขียนที่ สำนักงานคุมประพฤติจังหวัดสงขลา</p>
                  <p>วันที่: {new Date().toLocaleDateString("th-TH")}</p>
                </div>

                <div className="space-y-2">
                  <p><b>เรื่อง:</b> รายงานการบำเพ็ญประโยชน์สาธารณะและความพฤติของผู้ถูกคุมความประพฤติครบแผนที่กำหนด</p>
                  <p><b>เรียน:</b> ผู้พิพากษาศาลแขวงสงขลา</p>
                  
                  <p className="indent-8 text-justify">
                    ตามที่ศาลแขวงสงขลา ได้มีคำพิพากษาในคดีดำหมายเลข {activeProbationer.id} ให้ควบคุมความประพฤติ <b>{activeProbationer.name}</b> ฐานความผิดขับขี่รถจักรยานยนต์ขณะมึนเมาสุรา มีกำหนดระยะเวลา 1 ปี โดยสั่งให้ปฏิบัติกิจกรรมบริการสังคมและบำเพ็ญประโยชน์ครบ <b>{activeProbationer.requiredHours} ชั่วโมง</b> นั้น
                  </p>
                  
                  <p className="indent-8 text-justify">
                    บัดนี้ ผู้ถูกคุมความประพฤติรายดังกล่าว ได้รับความร่วมมือและปฏิบัติตามแผนฟื้นฟู มีส่วนร่วมทำความสะอาดทำนุบำรุงวัดเขารูปช้างและโรงเรียนวัดเขารูปช้างอย่างสม่ำเสมอ รวมสะสมผลงานได้ทั้งสิ้น <b>{activeProbationer.completedHours} ชั่วโมง</b> ครบถ้วนตามมาตรฐานทางกฎหมาย มีคะแนนวินัยความประพฤติอยู่ในเกณฑ์ดีเยี่ยม (<b>{activeProbationer.behaviorScore} คะแนน</b>) อีกทั้งผลตรวจสอบสารเสพติดเป็นศูนย์ ปฏิบัติธรรมถือวินัยสุจริต
                  </p>
